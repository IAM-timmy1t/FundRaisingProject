-- Combined Migrations for Blessed-Horizon
...
-- ================================================
-- MIGRATION 3: Storage Buckets (Run Separately)
-- ================================================
-- Note: Storage bucket creation must be done via Supabase Dashboard
-- Go to Storage section and create the following buckets:
-- 1. campaign-images (public, 5MB limit)
-- 2. campaign-videos (public, 50MB limit)
-- 3. update-media (public, 10MB limit)
-- 4. receipts (private, 5MB limit)
-- 5. avatars (public, 1MB limit)
